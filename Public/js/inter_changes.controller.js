(function(){
    'use strict';
    angular.module('inter_changes').controller('interChangesController', interChangesController);
    interChangesController.$inject = ['$scope', 'sendRequest'];
    function interChangesController($scope, sendRequest){
    	var vm = this;
    	vm.params = {};
		vm.baseIndex;
		...
		function getICList(params){
	 		var url = '/InterChanges/ICList/';
