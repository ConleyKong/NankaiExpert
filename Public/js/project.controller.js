(function(){
    ...
    function projectController($scope, sendRequest){
		...
		function getProjectList(params){
	 	...
	 	vm.exportParams = {person_name:false,name:false,type_name:false,support_no:false,join_unit:false,source:false,subtype:false,start_time:false,end_time:false,fund:false,direct_fund:false,indirect_fund:false,financial_account:false,comment:false};
	 	...
	 	function exportExcel(type){
	 		...
	 		var url = '/project/export/?type=' + type + '&query=' + vm.params + '&field=' + field;
			location.href = url;
	 		vm.showCheckbox = false;
	 	}
