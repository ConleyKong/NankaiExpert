    ...
    <div class="col-sm-12 row">
      ...
      <div class="panel panel-default table-header">
        <div class="panel-heading table-heading">
          ...
          <tbody>
            <tr ng-if="vm.paginationConf.totalItems" ng-repeat="item in vm.labList | filter:filter">
      ...
      <form method="post" action="<?php echo U('Lab/import');?>" enctype="multipart/form-data">
...
<script type="text/javascript" src="/Public/js/lab.controller.js"></script>
