    ...
    <div class="container" ng-app="event" ng-controller="eventController as vm">
        <div class="col-md-12">
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                <tr ng-if="vm.paginationConf.totalItems" ng-repeat="item in vm.eventList | filter:filter">
                    ...
                    <td><a href="/Home/Event/show_picture/?id={{item.id}}" target="_blank">查看</a></td>
                </tr>
...
function selectMenu(first, second, third){
    ...
    <script type="text/javascript" src="/Public/js/event.controller.js"></script>
