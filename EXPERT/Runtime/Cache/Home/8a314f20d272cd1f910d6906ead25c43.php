...
<body>
  ...
  <div class="container" ng-app="paper" ng-controller="paperController as vm">
    <div class="col-sm-12 row">
      <div class="col-sm-12">
          <span class="cond-label">作者单位：</span>
          <div class="btn-group">
      ...
      <div class="col-sm-12 bottom-10">
          <span class="cond-label">期刊名称：</span>
          <div class="btn-group">
            <input type="text" class="form-control" ng-model="vm.conference_name"/>
          </div>
      </div>
      <div class="col-sm-12 bottom-10">
          <span class="cond-label">发表时间：</span>
          <div class="btn-group">
            <form class="form-inline">
              <div class="form-group">
                <input type="text" class="form-control" ng-model="vm.pub_start" placeholder="时间格式：2010-10-10"/>
                至
              </div>
              <div class="form-group">
                <input type="text" class="form-control" ng-model="vm.pub_end" placeholder="时间格式：2010-10-10"/>
              </div>
            </form>
          </div>
      </div>
      ...
      <div class="panel panel-default table-header">
        ...
        <thead>
          <tr>
            ...
            <th>第一作者<input type="checkbox" ng-show="vm.showCheckbox" ng-model="vm.exportParams.person_name"></th>
            <th>第一作者单位<input type="checkbox" ng-show="vm.showCheckbox" ng-model="vm.exportParams.col_name"></th>
            <th>期刊/会议名称<input type="checkbox" ng-show="vm.showCheckbox" ng-model="vm.exportParams.conference_name"></th>
            <th>发表时间<input type="checkbox" ng-show="vm.showCheckbox" ng-model="vm.exportParams.publish_date"></th>
            <th>备注<input type="checkbox" ng-show="vm.showCheckbox" ng-model="vm.exportParams.comment"></th>
          </tr>
        </thead>
        <tbody>
          <tr ng-if="vm.paginationConf.totalItems" ng-repeat="item in vm.paperList | filter:filter">
            <td ng-bind="item.id"></td>
            <td ng-bind="item.person_name"></td>
            <td ng-bind="item.col_name"></td>
            <td ng-bind="item.conference_name"></td>
            <td ng-bind="item.publish_date"></td>
...
<script type="text/javascript" src="/Public/js/paper.controller.js"></script>
